...
<header class="mdui-appbar mdui-appbar-fixed">
    <div class="mdui-toolbar mdui-color-theme">
        ...
        <a href="javascript:;" class="mdui-typo-title">{{{trans 'page.login'}}}</a>
    ...
    <ul class="mdui-list" mdui-collapse="{accordion: true}">
        ...
        <li class="mdui-collapse-item mdui-collapse-item-open">
            ...
            <ul class="mdui-collapse-item-body mdui-list">
                <a href="{{{path 'login'}}}"><li class="mdui-list-item mdui-ripple mdui-list-item-active">{{{trans "index.login"}}}</li></a>
                <a href="{{{path 'reg'}}}"><li class="mdui-list-item mdui-ripple">{{{trans "index.reg"}}}</li></a>
            </ul>
        </li>
...
<div class="mdui-container doc-container doc-no-cover">
    <div class="mdui-row">
        <div class="mdui-col-sm-5">
            <h1 class="doc-title mdui-text-color-theme">{{{trans 'page.login'}}}</h1>
            <p>登录以管理您的角色及皮肤</p>
        </div>
        <div class="mdui-col-sm-6 mdui-col-offset-sm-1">
            <div class="mdui-card mdui-container-fluid yoshino-form">
                ...
                <div class="mdui-textfield">
                    <label class="mdui-textfield-label">{{{trans 'auth.identification'}}}</label>
                    <input class="mdui-textfield-input" type="text" name="identification" required/>
                </div>
                <div class="mdui-textfield">
             ...
             <button class="mdui-btn mdui-ripple mdui-text-color-theme login-button mdui-btn-block">{{{trans 'auth.login'}}}</button>
            </div>
        </div>
    </div>
</div>
