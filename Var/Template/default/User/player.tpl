...
<header class="mdui-appbar mdui-appbar-fixed">
    <div class="mdui-toolbar mdui-color-theme">
        ...
        <span style="padding-top: 2px;font-weight: 500;">{{{data "username"}}}</span>
    ...
    <ul class="mdui-list" mdui-collapse="{accordion: true}">
        ...
        <li class="mdui-collapse-item mdui-collapse-item-open">
            <div class="mdui-collapse-item-header mdui-list-item mdui-ripple">
                ...
                <div class="mdui-list-item-content">{{{trans "sidebar.user/manage"}}}</div>
                <i class="mdui-collapse-item-arrow mdui-icon material-icons">keyboard_arrow_down</i>
            </div>
            <ul class="mdui-collapse-item-body mdui-list">
                <a href="{{{path 'user.player'}}}"><li class="mdui-list-item mdui-ripple mdui-list-item-active">{{{trans "sidebar.user/player"}}}</li></a>
                <a href="{{{path 'user.skin'}}}"><li class="mdui-list-item mdui-ripple">{{{trans "sidebar.user/skin"}}}</li></a>
            </ul>
        </li>
